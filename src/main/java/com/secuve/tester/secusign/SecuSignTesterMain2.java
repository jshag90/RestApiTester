...
public class SecuSignTesterMain2 implements Runnable {
...
//				tc.callRegSign(restClient, sendData, userkey, signName, orientation, signData);
				...
				reg_sign_ids.add("156282577072801050655273");
	...
	public static void main(String[] args) {
		...
		SecuSignTesterMain2 ct = new SecuSignTesterMain2();
